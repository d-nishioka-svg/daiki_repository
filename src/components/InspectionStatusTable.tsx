              ...
              <>
                      ...
                      <td className="px-2 py-2 text-center">
                        <div className="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg p-1">
                          <button
                            ...
                            className="w-5 h-5 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-100 text-slate-650 flex items-center justify-center rounded-md cursor-pointer disabled:opacity-30 disabled:pointer-events-none transition-colors"
                            title="検品数を1減らす"
                          >
                          ...
                          <button
                            ...
                            className="w-5 h-5 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-100 text-slate-650 flex items-center justify-center rounded-md cursor-pointer transition-colors"
                            title="検品数を1増やす"
                          >
                ...
                {extraScannedItems.map((row, idx) => (
                  <tr key={`extra_${idx}`} className="h-11 bg-rose-50/20 hover:bg-rose-50/45 transition-colors text-xs font-medium">
                    ...
                    {/* 予定数 */}
                    <td className="px-2 py-2 text-center font-semibold text-slate-350">
                      0
                    </td>
                    ...
                    <td className="px-2 py-2 text-center">
                      <div className="inline-flex items-center gap-2 bg-rose-50/60 border border-rose-200 rounded-lg p-1">
                        <button
                          onClick={() => onAdjustQty(row.partNumber, row.size, row.color, false)}
                          className="w-5 h-5 bg-white border border-rose-200 hover:bg-rose-100 text-rose-750 flex items-center justify-center rounded-md cursor-pointer transition-colors"
                          title="検品数を1減らす"
                        >
